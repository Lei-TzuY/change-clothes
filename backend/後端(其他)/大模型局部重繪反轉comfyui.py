...
target_dir = r"D:\大模型局部重繪反轉"  # 目標資料夾路徑，用來存放搬移後的圖片
...
prompt_text = r"""
{
  ...
  "25": {
    "inputs": {
      "image_path": "D:\\comfyui\\ComfyUI_windows_portable\\ComfyUI\\output\\ComfyUI_00008_.png"
    },
...
# 原始圖 (注意：此處路徑為原始字串)
prompt["25"]["inputs"]["image_path"] = r"D:\comfyui\ComfyUI_windows_portable\ComfyUI\output\ComfyUI_00008_.png"
# 遮罩路徑 (注意：此處路徑為原始字串)
