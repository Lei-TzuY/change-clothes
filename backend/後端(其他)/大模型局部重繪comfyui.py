...
target_dir = r"D:\大模型局部重繪"  # 目標資料夾路徑，用來存放搬移後的圖片
...
prompt_text = r"""
{
  ...
  "28": {
    "inputs": {
      "image_path": "D:\\comfyui\\ComfyUI_windows_portable\\ComfyUI\\output\\ComfyUI_00013_.png"
    },
  ...
  "29": {
    "inputs": {
      "image_path": "C:\\Users\\User\\Desktop\\processed_mask.png"
    },
    "class_type": "ZwngLoadImagePathOrURL",
    "_meta": {
      "title": "Load Image Path or URL"
...
# 原始圖 (注意：此處路徑為原始字串)
prompt["28"]["inputs"]["image_path"] = r"D:\comfyui\ComfyUI_windows_portable\ComfyUI\output\ComfyUI_00013_.png"
# 遮罩路徑 (注意：此處路徑為原始字串)
prompt["29"]["inputs"]["image_path"] = r"C:\Users\User\Desktop\processed_mask.png"
