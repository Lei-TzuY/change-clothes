...
def wait_for_completion(prompt_id, client_id):
    ...
    當收到 'executing' 訊息，且其中的 node 為 None (並且 prompt_id 相符) 時，
    表示該流程已完成。
    """
...
# =============================
# 請注意：此處使用原始字串 (在開頭加上 r) 以避免跳脫字元錯誤
prompt_text = r"""
{
  "1": {
    "inputs": {
  ...
  "2": {
    "inputs": {
      "text": "vanilla,xiangcao,shouban,girl",
      "clip": [
        "15",
        1
      ]
...
prompt["16"]["inputs"]["image"] = r"C:\Users\User\Desktop\雷姆.png"  # 使用原始字串
