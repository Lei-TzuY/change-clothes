...
TARGET_DIR = r"D:\Lora大模型qcode"
os.makedirs(TARGET_DIR, exist_ok=True)

# 用於暫存產生之 QR Code 的資料夾 & 檔名
QR_OUTPUT_FOLDER = r"D:\Lora大模型qcode"
...
prompt_text = """
{
  ...
  "7": {
    "inputs": {
      "lora_name": "makima_hunyuan.safetensors",
      "strength_model": 0.7,
      "strength_clip": 0.7,
      "model": [
        "26",
...
if __name__ == "__main__":
    ...
    #Lora模型參數
    prompt["7"]["inputs"]["lora_name"] = "super-vanilla-newlora-ver1-p.safetensors"
    prompt["7"]["inputs"]["strength_model"] = 1
    prompt["7"]["inputs"]["strength_clip"] = 0.8

    # 載入 QR code 圖片路徑 (ID=30)
    # 建議在 JSON 中先以 E:/ 這種形式設定即可避免轉義問題
    prompt["30"]["inputs"]["image_path"] = QR_CODE_PATH.replace("\\", "/")
   #創意QRCODE控制網路
