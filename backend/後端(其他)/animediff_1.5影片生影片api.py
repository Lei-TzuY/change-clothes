...
prompt = {
    ...
    "109": {
        "inputs": {
            "video": "\"E:\\sd1.5_animediff_img2video_dataset\\AnimateDiff_00024.mp4\"",
            "force_rate": 0,
            "force_size": "Disabled",
            "custom_width": 512,
            "custom_height": 512,
...
# 提示詞前綴設定
prompt["101"]["inputs"]["text"] = "(Masterpiece, best quality:1.2), closeup, a guy walking through street"
...
# 短影片上傳設定
prompt["109"]["inputs"]["video"] = "E:/sd1.5_animediff_img2video_dataset/AnimateDiff_00024.mp4"
