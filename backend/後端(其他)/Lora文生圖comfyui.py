        ...
        while True:
            ...
            if isinstance(out, str):
                ...
                if message.get("type") == "executing":
                    ...
                    # 當 node 為 None 且 prompt_id 匹配時，認為流程完成
