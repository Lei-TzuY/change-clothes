...
target_dir = r"D:\Lora大模型局部重繪"  # 目標資料夾路徑，用來存放搬移後的圖片
...
prompt["2"]["inputs"]["text"] = "sun glasses"
...
prompt["22"]["inputs"]["lora_name"] = "super-vanilla-newlora-ver1-p.safetensors"
prompt["22"]["inputs"]["strength_model"] = 1
prompt["22"]["inputs"]["strength_clip"] = 0.8
# 原始圖 (注意：此處路徑為原始字串)
prompt["24"]["inputs"]["image_path"] = r"D:\comfyui\ComfyUI_windows_portable\ComfyUI\output\ComfyUI_00013_.png"
# 遮罩路徑 (注意：此處路徑為原始字串)
prompt["23"]["inputs"]["image_path"] = r"C:\Users\User\Desktop\processed_mask.png"
