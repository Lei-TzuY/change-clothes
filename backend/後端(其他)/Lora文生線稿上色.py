...
#lora模型參數
prompt["51"]["inputs"]["lora_name"] = "asuna_(stacia)-v1.5.safetensors"
prompt["51"]["inputs"]["strength_model"] = 1
prompt["51"]["inputs"]["strength_clip"] = 1
# 線搞圖上傳
